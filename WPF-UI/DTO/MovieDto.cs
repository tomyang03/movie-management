...
namespace Dto
{
    public class MovieDto
    {
        ...
        public MovieDto(int movieId, string title, int runtimeMinutes, string director, string production, string synopsys, string imagePath, string premiereDate, string season, string filmGenre)
        {
